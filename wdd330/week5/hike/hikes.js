...
const hikeList = [
  ...
  export default class Hikes {
    ...
    // loop through all hike elements and fill the UL with LI items
    ...
    showOneHike(hikeName) {
      // use hike name to get the hike object from the array
      hikeList.forEach(hike => {
        if (hike.name == hikeName) {
          return renderOneHikeFull(hike, this.parentElement);
        }
      });
    }
  ...
  function renderOneHikeFull(hike, parent) {
